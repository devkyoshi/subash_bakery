          ...
          <CardContent className="p-0 overflow-x-auto">
            ...
            <Table className="min-w-[800px]">
              <TableHeader className="bg-muted/50">
                <TableRow>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider w-[120px]">
                    PO No
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider w-[100px]">
                    Date
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider min-w-[140px]">
                    Supplier
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider min-w-[160px]">
                    Item
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider text-right w-[90px]">
                    PO Qty
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider text-right w-[90px]">
                    GRN Qty
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider text-right w-[100px]">
                    Variance
                  </TableHead>
                  <TableHead className="font-semibold text-xs text-muted-foreground uppercase tracking-wider w-[100px]">
                    Status
              ...
              <TableBody>
                {items.map((item, idx) => (
                  <TableRow key={`${item.po_id}-${item.product_id}-${idx}`} className="hover:bg-muted/50">
                    ...
                    <TableCell>
                      <div className="font-medium text-foreground text-sm truncate max-w-[180px]" title={item.supplier_name}>
                        {item.supplier_name}
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell className="text-right font-medium text-foreground text-sm tabular-nums">
                    ...
                    <TableCell
                      className={`text-right font-bold text-sm tabular-nums ${item.variance < 0 ? "text-red-500 dark:text-red-400" : item.variance > 0 ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}
                    >
                      {item.variance > 0 ? "+" : ""}
